...
export default function SensitivityPanel({
    ...
    const chartData = useMemo(() => {
        ...
        return isNumeric ? points : [...points].sort((a, b) => b.price - a.price)
    }, [result, isNumeric])
                ...
                {result && (
                    <div style={{marginTop: 20}}>
                        <ResponsiveContainer width="100%" height={360}>
                            {isNumeric ? (
                                <LineChart data={chartData} margin={{left: 30, right: 20}}>
                                ...
                                <BarChart data={chartData} margin={{left: 30, right: 20}}>
                                    <CartesianGrid strokeDasharray="3 3"/>
